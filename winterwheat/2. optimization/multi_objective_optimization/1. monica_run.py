...
def crop_json(base_path, irr_path, fert_path, crp_path, sim_start, sim_end, 
    ...
    set_param_path = os.path.join(base_monica, parameter_dir, f'wheat_run{i}', set_name)
...
def run_monica(base_path, project_dir, set_name, i):
    ...
    set_path = os.path.join(project_dir, f"wheat_run{i}", set_name)
    sim_json = "sim.json"
...
def calculate_objectives(set_name, project_dir_opt, project_dir_red,
    ...
    sim_csv_opt = os.path.join(project_dir_opt, f'wheat_run{i}', set_name, 'sim-out.csv')
    sim_csv_red = os.path.join(project_dir_red, f'wheat_run{i}', set_name, 'sim-out.csv')
