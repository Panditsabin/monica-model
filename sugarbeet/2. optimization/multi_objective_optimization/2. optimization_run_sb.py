...
if __name__ == '__main__':
    ...
    obs_moist_opt  = os.path.join(base_path, r"field_obs_data\sugarbeet_sm_opt_condition.xlsx")
    obs_moist_red  = os.path.join(base_path, r"field_obs_data\sugarbeet_sm_red_condition.xlsx")
    ...
    # sens para df
    para_df = pd.read_excel(r'C:\Users\Pandit\Desktop\monica\sensitive_paras\sugarbeet_yld_sm_sens_para.xlsx')
    ...
    # param dir
    parameter_dir  = r'C:\Users\Pandit\Desktop\monica\monica-parameters\sugarbeet_3objs'
    
    # project dir
    project_dir_opt = r'C:\Users\Pandit\Desktop\monica\projects\sugarbeet_3objs_opt'
    project_dir_red = r'C:\Users\Pandit\Desktop\monica\projects\sugarbeet_3objs_red'
    
    # optimization result save
    result_path = r'C:\Users\Pandit\Desktop\monica\projects\sugarbeet_3objs_result'
