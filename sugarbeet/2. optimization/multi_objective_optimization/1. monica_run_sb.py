...
def calculate_objectives(set_name, project_dir_opt, project_dir_red,
    ...
    sim_csv_opt = os.path.join(project_dir_opt, f'sugarbeet_run{i}', set_name, 'sim-out.csv')
    sim_csv_red = os.path.join(project_dir_red, f'sugarbeet_run{i}', set_name, 'sim-out.csv')
