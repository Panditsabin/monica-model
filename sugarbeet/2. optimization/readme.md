...
| File | Description |
|------|-------------|
| `1. monica_run_sb.py` | Core library — parameter mapping, JSON file updates, MONICA runner and objective function |
| `2. optimization_run_sb.py` | Defines the GA problem and runs the single-objective optimization loop |
| `3. post_process_sb.py` | Objective and parameter convergence analysis across generations |
| `4. monica_run_postprocess_sb.py` | Runs MONICA with the best calibrated parameters for both conditions over the full simulation period |
...
| Setting | Value |
|---------|-------|
| `sim_start` (calibration) | 2009-01-01 |
...
| File | Description |
|------|-------------|
| `1. monica_run_sb.py` | Core library — parameter mapping, JSON file updates, MONICA runner and three-objective function |
