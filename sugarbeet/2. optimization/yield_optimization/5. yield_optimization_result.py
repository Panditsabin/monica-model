...
import pandas as pd
import os
from monica_run_postprocess_sb import(map_parameters, update_parameter_files, site_json, crop_json, run_monica, process_yield_file)
import numpy as np
import matplotlib.pyplot as plt
from datetime import timedelta

from post_process_sb import (pareto_parameter, read_optimization_result)
import dill as pickle

from optimization_run_sb import MonicaSingleObjectiveProblem
...
def process_and_plot_condition(ax, color, best_x, param_names, proj_dir, parameter_dir, 
    ...
    # read sim file
    sim_out_csv = os.path.join(proj_dir, f'sugarbeet_run{i}', set_name, 'sim-out.csv')
...
if __name__ == '__main__':
     ...
     # Parameters value
     sens_df = pd.read_excel(os.path.join(base_path, r'sensitive_paras\sugarbeet_sens_main_paras.xlsx'))
     ...
     # pareto result
     result_path = r'C:\Users\Pandit\Desktop\monica\projects\sugarbeet_yield_results'
