...
from sugarbeet_morris_multiprocess import (map_parameters, update_parameter_files, crop_json, site_json,
...
if __name__ == '__main__':
    ...
    # management files
    irr_data_path  = os.path.join(base_path, r'magagement_data\sugarbeet_reduced\reduced_irrigation.xlsx')
    fert_data_path = os.path.join(base_path, r'magagement_data\sugarbeet_reduced\fertilizer.xlsx')
    crp_data_path  = os.path.join(base_path, r'magagement_data\sugarbeet_reduced\crop_mgmt_ZR.xlsx')
    ...
    # folders
    parameter_dir = os.path.join(base_path, r'monica-parameters\sugarbeet_morris_sa_reduced')
    project_dir   = os.path.join(base_path, r'projects\sugarbeet_morris_sa_reduced')
    ...
    # text files
    save_to_txt(yield_results,      'sugarbeet_yld.txt', results_dir)
    save_to_txt(irrigation_results, 'sugarbeet_irr.txt', results_dir)
    save_to_txt(moisture_results,   'sugarbeet_sm.txt',  results_dir)
