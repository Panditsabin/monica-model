...
from potato_morris_multiprocess import (map_parameters, update_parameter_files, crop_json, site_json,
...
if __name__ == '__main__':
    ...
    # management files
    irr_data_path  = os.path.join(base_path, r'magagement_data\potato_reduced\reduced_irrigation.xlsx')
    fert_data_path = os.path.join(base_path, r'magagement_data\potato_reduced\fertilizer.xlsx')
    crp_data_path  = os.path.join(base_path, r'magagement_data\potato_reduced\crop_mgmt_MEP.xlsx')
    ...
    cultivar_file = os.path.join(base_path, r"monica-parameters\crops\potato\moderately-early-potato.json") 
    species_file = os.path.join(base_path, r"monica-parameters\crops\potato.json")
    ...
    morris_df   = pd.read_excel(os.path.join(base_path, r'sa_analysis\potato_morris.xlsx'))
    param_names = morris_df.columns.to_list()

    # folders
    parameter_dir = os.path.join(base_path, r'monica-parameters\potato_morris_sa_reduced')
    project_dir   = os.path.join(base_path, r'projects\potato_morris_sa_reduced')
    ...
    obs_moist_path = os.path.join(base_path, r'field_obs_data\potato_sm_red_condition.xlsx')
    ...
    # text files
    save_to_txt(yield_results,      'potato_yld.txt', results_dir)
    save_to_txt(irrigation_results, 'potato_irr.txt', results_dir)
    save_to_txt(moisture_results,   'potato_sm.txt',  results_dir)
