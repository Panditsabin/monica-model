...
if __name__ == '__main__':
    ...
    obs_moist_opt  = os.path.join(base_path, r"field_obs_data\potato_sm_opt_condition.xlsx")
    obs_moist_red  = os.path.join(base_path, r"field_obs_data\potato_sm_red_condition.xlsx")
    ...
    # sens para df
    para_df = pd.read_excel(r'C:\Users\Pandit\Desktop\monica\sensitive_paras\potato_yld_sm_sens_para.xlsx')
    ...
    # simulation period
    sim_start, sim_end = '2006-01-01', '2015-12-31'
    
    # param dir
    parameter_dir  = r'C:\Users\Pandit\Desktop\monica\monica-parameters\potato_3objs'
    
    # project dir
    project_dir_opt = r'C:\Users\Pandit\Desktop\monica\projects\potato_3objs_opt'
    project_dir_red = r'C:\Users\Pandit\Desktop\monica\projects\potato_3objs_red'
    
    # optimization result save
    result_path = r'C:\Users\Pandit\Desktop\monica\projects\potato_3objs_result'
